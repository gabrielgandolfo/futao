        ...
        <header class="navbar navbar-expand-md d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        <img src="{{ asset('assets/dist/img/logo.png') }}" width="110" height="32" alt="Tabler"
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <span class="avatar avatar-sm"
                                style="background-image: url({{ asset('assets/dist/img/flags/ar.svg') }})"></span>
        ...
        <header class="navbar-expand-md">
            <div class="collapse navbar-collapse" id="navbar-menu">
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            <li class="nav-item {{ request()->is('home') ? 'active' : 'hidden' }}">
                            ...
                            <li class="nav-item {{ request()->is('players*') ? 'active' : 'hidden' }}">
                        ...
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    ...
                                    Desenvolvido por Gabriel Gandolfo.
                                    - Layout por Tabler
                                </li>
                                <li class="list-inline-item">
